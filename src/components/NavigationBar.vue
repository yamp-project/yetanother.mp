    ...
    >
        ...
        <RouterLink to="/">
          <div class="flex justify-center items-center gap-2.5">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M20.6142 26.2313C19.6901 27.8889 17.3055 27.8892 16.381 26.2318L10.9763 16.5429C10.0905 14.9549 11.2385 13 13.0569 13C13.9143 13 14.7055 13.4607 15.1287 14.2064L20.6051 23.8549C21.0229 24.5911 21.0264 25.4919 20.6142 26.2313Z" fill="#BC82F3" />
      ...
      <div class="hidden sm:flex justify-center items-center gap-2.5">
        ...
        <a
          ...
          class="flex justify-center items-center p-2 rounded-[10px] hover:bg-white/10 transition-colors text-white"
        >
        <svg width="18" height="18" viewBox="0 0 320 244" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M101.313 172.793L0 0H58.0695L130.965 122.189L101.313 172.793Z" fill="white"/>
        <path d="M202.625 0H117.375L139.614 35.7928L161.853 71.5856L202.625 0Z" fill="white"/>
        <path d="M320 0H261.93L133.436 222.162L161.853 274L320 0Z" fill="white"/>
        </svg>
        </a>
      </div>
      ...
      <button
        @click="toggleMenu"
        class="md:hidden p-2.5 flex items-center justify-center hover:bg-white/5 rounded transition-colors"
      >
        <MenuIcon v-if="!isMenuOpen" :size="24" class="text-white" />
        <CloseIcon v-else :size="24" class="text-white" />
      </button>
    </div>
  </nav>
  ...
  <transition name="slide-fade">
    ...
    >
      <div class="flex flex-col px-4 gap-2">
        <!-- Mobile menu links go here if needed -->
      </div>
    </div>
  </transition>
</template>
